...
var searchBarFilter = function searchBarFilter(input) {
  ...
  if (result.length == 0) {
    ...
    _searchResult.appendChild(_result);
  } else {
    buildCards(result);
  }
...
}, 350); // score 2,13 *  3.8 * 3.4 * 3.5 * 3.9 * 3.7
// setTimeout(() => {
//   for (let i = 0; i < 50; i++) {
...
/******/ })()
;
//# sourceMappingURL=fa8efc3d6d73b09e6b1c.js.map