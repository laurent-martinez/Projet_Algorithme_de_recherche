        ...
        switch (tag.type) {
          case "ingredients":
            ...
            var _loop = function _loop(i) {
              _this.recipes[i].ingredients.some(function (ingredient) {
                if (ingredient.ingredient.toLowerCase().includes(tag.value.toLowerCase())) {
                  ingArray.push(_this.recipes[i]);
          ...
          case "appliance":
            ...
            for (var _i = 0; _i < _this.recipes.length; _i++) {
              if (_this.recipes[_i].appliance.toLowerCase().includes(tag.value.toLowerCase())) {
                appArray.push(_this.recipes[_i]);
                console.log(appArray);
              }
            }

            _this.recipes = appArray;
            break;
          ...
          case "ustensils":
            ...
            var _loop2 = function _loop2(_i2) {
              _this.recipes[_i2].ustensils.some(function (ustensil) {
                if (ustensil.toLowerCase().includes(tag.value.toLowerCase())) {
                  usArray.push(_this.recipes[_i2]);
                  console.log(usArray);
                }
              });
            };

            for (var _i2 = 0; _i2 < _this.recipes.length; _i2++) {
              _loop2(_i2);
            }

            _this.recipes = usArray;
            break;
        }
      })();
...
/***/ "./src/scripts/dropdownOpening.js":
/*!****************************************!*\
  !*** ./src/scripts/dropdownOpening.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var dropdownOpen = function dropdownOpen() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildApplianceList": () => (/* binding */ buildApplianceList),
/* harmony export */   "buildIngredientsList": () => (/* binding */ buildIngredientsList),
/* harmony export */   "buildUstensilsList": () => (/* binding */ buildUstensilsList)
/* harmony export */ });
...
var buildIngredientsList = function buildIngredientsList(recipes, tagIngredients) {
...
var buildApplianceList = function buildApplianceList(recipes, tagAppliance) {
...
var buildUstensilsList = function buildUstensilsList(recipes, tagUstensils) {
  ustensilsResult.innerHTML = "";
  var ustensilsArray = [];
  recipes.map(function (recipe) {
    var ustensils = recipe.ustensils;
    ustensils.forEach(function (ustensil) {
      return ustensilsArray.push(ustensil);
    });
  });

  var ustensilsList = _toConsumableArray(new Set(ustensilsArray)).sort();

  var inputUstensils = document.querySelector("#search-ustensils").value;
  ustensilsList = ustensilsList.filter(function (ustensil) {
    return !tagUstensils.includes(ustensil) && ustensil.toLowerCase().includes(inputUstensils.toLowerCase());
  });
  ustensilsList.forEach(function (ustensil) {
    ustensilsResult.insertAdjacentHTML("beforeend", "<p class=\"item-list item-ustensils\">".concat(ustensil, "</p>"));
  });
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n/***************************************************\nGLOBAL\n***************************************************/\n* {\n  box-sizing: border-box;\n  margin: 0;\n}\n\n.flex {\n  display: flex;\n}\n\n.clearfix:before,\n.clearfix:after {\n  content: \"\";\n  display: table;\n}\n\n.clearfix:after {\n  clear: both;\n}\n\nimg,\niframe,\nvideo {\n  max-width: 100%;\n  vertical-align: middle;\n}\n\nnav ul {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n\na {\n  text-decoration: none;\n  color: rgb(6, 143, 177);\n  transition: all 0.5s ease;\n}\n\n/***************************************************\nSTRUCTURE\n***************************************************/\n#wrapper {\n  display: flex;\n  flex-direction: column;\n  width: 85%;\n  margin: 0 auto;\n}\n\n/***************************************************\nTYPO\n***************************************************/\n.btn {\n  background-color: rgba(0, 0, 0, 0.3);\n  border: none;\n  font-size: 0.75rem;\n  padding: 0.7rem 1.25rem;\n  font-weight: 700;\n  color: rgb(255, 255, 255);\n  line-height: 100%;\n  border-radius: 20px;\n  text-align: center;\n  text-transform: uppercase;\n  cursor: pointer;\n}\n\n:root {\n  --primary: #3282f7;\n  --secondary: #69d9a4;\n  --tertiary: #ed6454;\n  --white: #fff;\n  /* nuance */\n  --primary-shade: #2c72d8;\n  --secondary-shade: #5cbe90;\n  --tertiary-shade: #cf584a;\n  /* teinte */\n  --primary-hue: hsl(216, 29%, 84%);\n  --secondary-hue: hsl(151, 17%, 86%);\n  --tertiary-hue: hsl(6, 23%, 86%);\n  --error: rgb(167, 25, 25);\n}\n\nbody {\n  margin: 0;\n}\n\nheader {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 15px 0;\n}\n\n#title {\n  color: #d04f4f;\n  font-weight: 700;\n  font-size: 38px;\n  font-family: \"DM Sans\", sans-serif;\n  line-height: 46.87px;\n  white-space: nowrap;\n}\n\nli {\n  list-style: none;\n}\n\n#inputs {\n  display: flex;\n  flex-wrap: wrap;\n  /* gère l'espace entre les box row & column */\n  gap: 0px 20px;\n}\n\ninput {\n  outline: none;\n  border: none;\n  border-radius: 5px;\n  padding: 0px;\n  margin: 20px 0px;\n}\n\n#searchBar-input {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat right 10px center;\n  background-color: #e7e7e7;\n  display: inline-block;\n  width: 100%;\n  padding: 15px;\n  font-size: 18px;\n  line-height: 21.6px;\n  color: rgb(0, 0, 0);\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  height: 69px;\n}\n\n#searchBar-input::placeholder {\n  color: rgba(0, 0, 0, 0.25);\n}\n\n.all::placeholder {\n  color: rgb(152, 192, 251);\n}\n\n#search-ingredients:active::placeholder,\n#search-appliance:active::placeholder,\n#search-ustensils:active::placeholder {\n  color: rgba(255, 255, 255, 0.5);\n}\n\n#search-ingredients::placeholder,\n#search-appliance::placeholder,\n#search-ustensils::placeholder {\n  font-size: 18px;\n  line-height: 21.6px;\n  color: rgb(255, 255, 255);\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n}\n\n#search-ingredients,\n#search-appliance,\n#search-ustensils {\n  padding: 15px 15px 15px 10px;\n  color: rgb(255, 255, 255);\n  font-weight: 600;\n  width: 170px;\n  height: 69px;\n}\n\n#search-ingredients {\n  background-color: var(--primary);\n}\n\n#search-appliance {\n  background-color: var(--secondary);\n}\n\n#search-ustensils {\n  background-color: var(--tertiary);\n}\n\n#ingredients, #appliance, #ustensils {\n  position: relative;\n  cursor: pointer;\n}\n\n#chevron-ingredients, #chevron-appliance, #chevron-ustensils {\n  position: absolute;\n  right: 15px;\n  top: 45px;\n}\n\n.chevron-down {\n  transform: rotate(180deg);\n}\n\n.recipe {\n  height: 450px;\n}\n\n.recipe-image {\n  background-color: #c7bebe;\n  width: 100%;\n  height: 50%;\n  border-radius: 5px 5px 0px 0px;\n}\n\n.recipe-body {\n  padding: 0 10px;\n  margin-bottom: 20px;\n  background-color: #e7e7e7;\n  height: 50%;\n  padding: 15px 15px;\n  border-radius: 0px 0px 5px 5px;\n  overflow: hidden;\n}\n\n.recipe-header {\n  display: flex;\n  justify-content: space-between;\n}\n\n.recipe-title h2 {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  line-height: 21.6px;\n  font-size: 20px;\n}\n\n.recipe-time {\n  display: flex;\n  position: relative;\n}\n\n.recipe-time p {\n  width: 60px;\n  text-align: end;\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  font-size: 18px;\n  line-height: 21.6px;\n}\n\n.recipe-content {\n  display: flex;\n  justify-content: space-between;\n  padding-top: 10px;\n  padding-bottom: 10px;\n  font-size: 0.7rem;\n  max-height: 140px;\n}\n\n.recipe-ingredients,\n.recipe-describe {\n  width: 50%;\n}\n\n.recipe-ingredients {\n  font-family: \"Lato\", sans-serif;\n  font-size: 15px;\n  line-height: 16.4px;\n  font-weight: 700;\n}\n\n.recipe-describe {\n  font-weight: 400;\n  padding-left: 15px;\n  font-family: \"Roboto\", sans-serif;\n  font-size: 15px;\n  line-height: 15px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 12;\n  -webkit-box-orient: vertical;\n}\n\nul #search-result {\n  margin: 0;\n}\n\ni {\n  text-transform: lowercase;\n}\n\n#list-ingredients-result {\n  background-color: var(--primary);\n  width: 500px;\n  height: 290px;\n  overflow-x: scroll;\n}\n#list-ingredients-result::-webkit-scrollbar {\n  background: var(--primary);\n}\n#list-ingredients-result::-webkit-scrollbar-thumb {\n  background: white;\n  border-radius: 2px;\n  border: 4px solid var(--primary);\n}\n\n#list-appliance-result {\n  background-color: var(--secondary);\n  width: 500px;\n  height: 290px;\n}\n\n#list-ustensils-result {\n  background-color: var(--tertiary);\n  width: 500px;\n  height: 290px;\n  overflow-x: scroll;\n}\n#list-ustensils-result::-webkit-scrollbar {\n  background: var(--tertiary);\n}\n#list-ustensils-result::-webkit-scrollbar-thumb {\n  background: white;\n  border-radius: 2px;\n  border: 4px solid var(--tertiary);\n}\n\n#ingredients {\n  display: flex;\n  flex-direction: column;\n}\n\n.list-result {\n  display: none;\n  flex-direction: column;\n  flex-wrap: wrap;\n  border-radius: 0px 0px 5px 5px;\n  color: var(--white);\n  margin: -20px 0px 20px 0px;\n}\n\n#searchBar {\n  margin-bottom: 0px;\n}\n\n#search-result {\n  margin-top: -50px;\n  z-index: -1;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-gap: 40px;\n  border-radius: 20px;\n  margin-top: 50px;\n}\n\n.result {\n  top: 60%;\n  right: 40%;\n  display: flex;\n  justify-content: center;\n  text-align: center;\n}\n\n.no-result {\n  background-color: hsl(216deg, 29%, 84%);\n  margin-top: 20px;\n  padding: 20px;\n  color: #d04f4f;\n  text-align: center;\n  font-family: \"Roboto\", sans-serif;\n  font-size: 32px;\n  white-space: nowrap;\n  border-radius: 5px;\n  display: flex;\n  justify-content: center;\n}\n\n.item-list {\n  padding: 5px 20px 5px 20px;\n  color: white;\n  display: inline-block;\n  margin-bottom: 0;\n  position: relative;\n}\n.item-list::after {\n  background: none repeat scroll 0 0 transparent;\n  bottom: 0;\n  content: \"\";\n  display: block;\n  height: 5px;\n  position: absolute;\n  background: #fff;\n  transition: width 0.1s ease 0s, left 0.1s ease 0s;\n  width: 0;\n}\n.item-list:hover::after {\n  width: 60%;\n  left: 10%;\n}\n\n.show-list {\n  display: block;\n}\n\n#tags {\n  display: flex;\n  flex-wrap: wrap;\n}\n\n.tag {\n  display: flex;\n  justify-content: space-between;\n  color: var(--white);\n  padding: 10px 15px;\n  border-radius: 5px;\n  border-style: none;\n  margin: 5px 10px 5px 5px;\n  align-items: center;\n}\n\n.close-tag {\n  height: 20px;\n  width: 20px;\n  padding-left: 3px;\n  display: block;\n  color: white;\n  cursor: pointer;\n}\n\n.tag-ingredients {\n  background-color: var(--primary);\n}\n\n.tag-appliance {\n  background-color: var(--secondary);\n}\n\n.tag-ustensils {\n  background-color: var(--tertiary);\n}\n\n.fa-xmark {\n  color: white;\n  border: 2px solid white;\n  border-radius: 50%;\n  display: flex;\n  margin-left: 10px;\n}\n\n.fa-xmark::before {\n  /* centrage */\n  line-height: 16px;\n}\n\n/* je relie les deux class */\n.combo-box.open .list-result {\n  display: flex;\n}\n\n.combo-box.open .chevron {\n  transform: rotate(180deg);\n  transition: transform 0.2s;\n}\n\n.combo-box.open input {\n  border-radius: 5px 5px 0px 0px;\n}\n\n.combo-box.open .i::placeholder {\n  color: var(--primary-hue) !important;\n}\n\n.combo-box.open .a::placeholder {\n  color: var(--secondary-hue) !important;\n}\n\n.combo-box.open .u::placeholder {\n  color: var(--tertiary-hue) !important;\n}\n\n.combo-box.open #search-ingredients {\n  width: 100%;\n}\n\n.combo-box.open #search-appliance {\n  width: 100%;\n}\n\n.combo-box.open #search-ustensils {\n  width: 100%;\n}\n\n@media screen and (min-width: 1294px) {\n  #list-ingredients-result, #list-appliance-result, #list-ustensils-result {\n    margin-bottom: -200px;\n  }\n}\n@media screen and (max-width: 1294px) {\n  #inputs {\n    flex-direction: column;\n    align-items: center;\n  }\n\n  #ingredients, #appliance, #ustensils {\n    width: 60%;\n  }\n\n  #list-ingredients-result, #list-appliance-result, #list-ustensils-result {\n    width: 100%;\n  }\n\n  #search-ingredients, #search-appliance, #search-ustensils {\n    width: 100%;\n  }\n}\n/***************************************************\nTABLETTE\n***************************************************/\n@media screen and (max-width: 768px) {\n  #ingredients, #appliance, #ustensils {\n    width: 100%;\n  }\n\n  .container {\n    width: 100%;\n  }\n\n  #search-result {\n    grid-template-columns: repeat(2, 1fr) !important;\n  }\n}\n/***************************************************\nMOBILE\n***************************************************/\n@media screen and (max-width: 425px) {\n  #search-result {\n    grid-template-columns: auto !important;\n  }\n\n  #title {\n    font-size: 30px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB;;mDAAA;AAGA;EACE,sBAAA;EACA,SAAA;AAEF;;AACA;EACE,aAAA;AAEF;;AACA;;EAEE,WAAA;EACA,cAAA;AAEF;;AACA;EACE,WAAA;AAEF;;AACA;;;EAGE,eAAA;EACA,sBAAA;AAEF;;AACA;EACE,gBAAA;EACA,UAAA;EACA,SAAA;AAEF;;AACA;EACE,qBAAA;EACA,uBAAA;EACA,yBAAA;AAEF;;AAAA;;mDAAA;AAGA;EACE,aAAA;EACA,sBAAA;EACA,UAAA;EACA,cAAA;AAGF;;AADA;;mDAAA;AAIA;EACE,oCAAA;EACA,YAAA;EACA,kBAAA;EACA,uBAAA;EACA,gBAAA;EACA,yBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EACA,yBAAA;EACA,eAAA;AAGF;;AACA;EACE,kBAAA;EACA,oBAAA;EACA,mBAAA;EACA,aAAA;EAEA,WAAA;EACA,wBAAA;EACA,0BAAA;EACA,yBAAA;EAEA,WAAA;EACA,iCAAA;EACA,mCAAA;EACA,gCAAA;EAEA,yBAAA;AADF;;AAIA;EACE,SAAA;AADF;;AAIA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,eAAA;AADF;;AAIA;EACE,cAAA;EACA,gBAAA;EACA,eAAA;EACA,kCAAA;EACA,oBAAA;EACA,mBAAA;AADF;;AAIA;EACE,gBAAA;AADF;;AAIA;EACE,aAAA;EACA,eAAA;EACA,6CAAA;EACA,aAAA;AADF;;AAKA;EACE,aAAA;EACA,YAAA;EACA,kBAAA;EACA,YAAA;EACA,gBAAA;AAFF;;AAKA;EACE,+EAAA;EACA,yBAAA;EACA,qBAAA;EACA,WAAA;EACA,aAAA;EACA,eAAA;EACA,mBAAA;EACA,mBAAA;EACA,+BAAA;EACA,gBAAA;EACA,YAAA;AAFF;;AAKA;EACE,0BAAA;AAFF;;AAKA;EACE,yBAAA;AAFF;;AAKA;;;EAGE,+BAAA;AAFF;;AAIA;;;EAGE,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,+BAAA;EACA,gBAAA;AADF;;AAGA;;;EAGE,4BAAA;EACA,yBAAA;EACA,gBAAA;EACA,YAAA;EACA,YAAA;AAAF;;AAGA;EACE,gCAAA;AAAF;;AAGA;EACE,kCAAA;AAAF;;AAGA;EACE,iCAAA;AAAF;;AAIA;EACE,kBAAA;EACA,eAAA;AADF;;AAIA;EACE,kBAAA;EACA,WAAA;EACA,SAAA;AADF;;AAIA;EACE,yBAAA;AADF;;AAIA;EACE,aAAA;AADF;;AAIA;EACE,yBAAA;EACA,WAAA;EACA,WAAA;EACA,8BAAA;AADF;;AAIA;EACE,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,WAAA;EACA,kBAAA;EACA,8BAAA;EACA,gBAAA;AADF;;AAIA;EACE,aAAA;EACA,8BAAA;AADF;;AAIA;EACE,+BAAA;EACA,gBAAA;EACA,mBAAA;EACA,eAAA;AADF;;AAIA;EACE,aAAA;EACA,kBAAA;AADF;;AAIA;EACE,WAAA;EACA,eAAA;EACA,+BAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;AADF;;AAIA;EACE,aAAA;EACA,8BAAA;EACA,iBAAA;EACA,oBAAA;EACA,iBAAA;EACA,iBAAA;AADF;;AAIA;;EAEE,UAAA;AADF;;AAIA;EACE,+BAAA;EACA,eAAA;EACA,mBAAA;EACA,gBAAA;AADF;;AAOA;EACE,gBAAA;EACA,kBAAA;EACA,iCAAA;EACA,eAAA;EACA,iBAAA;EACA,gBAAA;EACA,uBAAA;EACA,oBAAA;EACA,sBAAA;EACA,4BAAA;AAJF;;AAQA;EACE,SAAA;AALF;;AAQA;EACE,yBAAA;AALF;;AAQA;EACG,gCAAA;EACD,YAAA;EACA,aAAA;EACA,kBAAA;AALF;AAME;EACE,0BAAA;AAJJ;AAME;EACE,iBAAA;EACA,kBAAA;EACA,gCAAA;AAJJ;;AAQA;EACG,kCAAA;EACD,YAAA;EACA,aAAA;AALF;;AAQA;EACG,iCAAA;EACD,YAAA;EACA,aAAA;EACA,kBAAA;AALF;AAME;EACE,2BAAA;AAJJ;AAME;EACE,iBAAA;EACA,kBAAA;EACA,iCAAA;AAJJ;;AAQA;EACE,aAAA;EACA,sBAAA;AALF;;AAQA;EACE,aAAA;EACA,sBAAA;EACA,eAAA;EACA,8BAAA;EACA,mBAAA;EACA,0BAAA;AALF;;AAOA;EACE,kBAAA;AAJF;;AAOA;EACE,iBAAA;EACA,WAAA;EACA,aAAA;EACA,qCAAA;EACA,cAAA;EACA,mBAAA;EACA,gBAAA;AAJF;;AAQA;EACE,QAAA;EACA,UAAA;EACA,aAAA;EACF,uBAAA;EACA,kBAAA;AALA;;AAOA;EACE,uCAAA;EACA,gBAAA;EACA,aAAA;EACA,cAAA;EACA,kBAAA;EACA,iCAAA;EACA,eAAA;EACA,mBAAA;EACA,kBAAA;EACA,aAAA;EACA,uBAAA;AAJF;;AAMA;EACE,0BAAA;EACC,YAAA;EACD,qBAAA;EACA,gBAAA;EACA,kBAAA;AAHF;AAIE;EACA,8CAAA;EACA,SAAA;EACA,WAAA;EACA,cAAA;EACA,WAAA;EACA,kBAAA;EACA,gBAAA;EACA,iDAAA;EACA,QAAA;AAFF;AAIE;EACE,UAAA;EACA,SAAA;AAFJ;;AAmBA;EACE,cAAA;AAhBF;;AAmBA;EACE,aAAA;EACA,eAAA;AAhBF;;AAmBA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,kBAAA;EACA,kBAAA;EACA,kBAAA;EACA,wBAAA;EACA,mBAAA;AAhBF;;AAmBA;EACE,YAAA;EACA,WAAA;EACA,iBAAA;EACA,cAAA;EACA,YAAA;EACA,eAAA;AAhBF;;AAmBA;EACE,gCAAA;AAhBF;;AAmBA;EACE,kCAAA;AAhBF;;AAmBA;EACE,iCAAA;AAhBF;;AAmBA;EACE,YAAA;EACA,uBAAA;EACA,kBAAA;EACA,aAAA;EACA,iBAAA;AAhBF;;AAmBA;EACE,aAAA;EACA,iBAAA;AAhBF;;AAmBA,4BAAA;AACA;EACE,aAAA;AAhBF;;AAmBA;EACE,yBAAA;EACA,0BAAA;AAhBF;;AAmBA;EACE,8BAAA;AAhBF;;AAoBA;EACE,oCAAA;AAjBF;;AAoBA;EACE,sCAAA;AAjBF;;AAmBA;EACE,qCAAA;AAhBF;;AAmBA;EACE,WAAA;AAhBF;;AAkBA;EACE,WAAA;AAfF;;AAiBA;EACE,WAAA;AAdF;;AAiBA;EACE;IACE,qBAAA;EAdF;AACF;AAkBA;EACE;IACE,sBAAA;IACA,mBAAA;EAhBF;;EAkBA;IACE,UAAA;EAfF;;EAiBA;IACE,WAAA;EAdF;;EAgBA;IACE,WAAA;EAbF;AACF;AAeA;;mDAAA;AAGA;EACE;IACE,WAAA;EAbF;;EAeA;IACI,WAAA;EAZJ;;EAcA;IACI,gDAAA;EAXJ;AACF;AAcA;;mDAAA;AAGA;EACE;IACI,sCAAA;EAZJ;;EAcA;IACE,eAAA;EAXF;AACF","sourcesContent":["/***************************************************\nGLOBAL\n***************************************************/\n* {\n  box-sizing: border-box;\n  margin: 0;\n}\n\n.flex {\n  display: flex;\n}\n\n.clearfix:before,\n.clearfix:after {\n  content: \"\";\n  display: table;\n}\n\n.clearfix:after {\n  clear: both;\n}\n\nimg,\niframe,\nvideo {\n  max-width: 100%;\n  vertical-align: middle;\n}\n\nnav ul {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n\na {\n  text-decoration: none;\n  color:rgb(6, 143, 177);\n  transition: all .5s ease;\n}\n/***************************************************\nSTRUCTURE\n***************************************************/\n#wrapper{\n  display: flex;\n  flex-direction: column;\n  width: 85%;\n  margin: 0 auto; \n}\n/***************************************************\nTYPO\n***************************************************/\n\n.btn{\n  background-color: rgba(0, 0, 0, 0.3);\n  border:none;\n  font-size: .75rem;\n  padding: .7rem 1.25rem;\n  font-weight: 700;\n  color: rgb(255, 255, 255);\n  line-height: 100%;\n  border-radius: 20px;\n  text-align: center;\n  text-transform: uppercase;\n  cursor: pointer;\n}\n\n\n:root {\n  --primary: #3282f7;\n  --secondary: #69d9a4;\n  --tertiary: #ed6454;\n  --white: #fff;\n\n  /* nuance */\n  --primary-shade: #2c72d8;\n  --secondary-shade: #5cbe90;\n  --tertiary-shade: #cf584a;\n  \n  /* teinte */\n  --primary-hue: hsl(216, 29%, 84%);\n  --secondary-hue: hsl(151, 17%, 86%);\n  --tertiary-hue: hsl(6, 23%, 86%);\n\n  --error: rgb(167, 25, 25);\n}\n\nbody {\n  margin: 0;\n}\n\nheader {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 15px 0;\n}\n\n#title {\n  color: #d04f4f;\n  font-weight: 700;\n  font-size: 38px;\n  font-family: 'DM Sans', sans-serif;\n  line-height: 46.87px;\n  white-space: nowrap;\n}\n\nli {\n  list-style: none;\n}\n\n#inputs {\n  display: flex;\n  flex-wrap: wrap;\n  /* gère l'espace entre les box row & column */\n  gap: 0px 20px;\n  \n}\n\ninput {\n  outline: none;\n  border: none;\n  border-radius: 5px;\n  padding: 0px;\n  margin: 20px 0px;\n}\n\n#searchBar-input {\n  background: url(../assets/magnifying_glass.svg) no-repeat right 10px center;\n  background-color: #e7e7e7;\n  display: inline-block;\n  width: 100%;\n  padding: 15px;\n  font-size: 18px;\n  line-height: 21.6px;\n  color: rgba(0,0,0);\n  font-family: 'Lato', sans-serif;\n  font-weight: 400;\n  height: 69px;\n}\n\n#searchBar-input::placeholder {\n  color: rgba(0,0,0,0.25);\n}\n\n.all::placeholder {\n  color: rgb(152,192,251)\n}\n\n#search-ingredients:active::placeholder,\n#search-appliance:active::placeholder,\n#search-ustensils:active::placeholder {\n  color: rgba(255, 255, 255, 0.5);\n}\n#search-ingredients::placeholder,\n#search-appliance::placeholder,\n#search-ustensils::placeholder {\n  font-size: 18px;\n  line-height: 21.6px;\n  color: rgba(255, 255, 255, 1);\n  font-family: 'Lato', sans-serif;\n  font-weight: 700;\n}\n#search-ingredients,\n#search-appliance,\n#search-ustensils {\n  padding: 15px 15px 15px 10px;\n  color: rgba(255, 255, 255, 1);\n  font-weight: 600;\n  width: 170px;\n  height: 69px;\n}\n\n#search-ingredients {\n  background-color: var(--primary);\n}\n\n#search-appliance {\n  background-color: var(--secondary);\n}\n\n#search-ustensils {\n  background-color: var(--tertiary);\n}\n\n\n#ingredients, #appliance, #ustensils {\n  position: relative;\n  cursor: pointer;\n}\n\n#chevron-ingredients, #chevron-appliance, #chevron-ustensils {\n  position: absolute;\n  right: 15px;\n  top: 45px;\n}\n\n.chevron-down {\n  transform: rotate(180deg);\n}\n\n.recipe {\n  height: 450px;\n}\n\n.recipe-image {\n  background-color: #c7bebe;\n  width: 100%;\n  height: 50%;\n  border-radius: 5px 5px 0px 0px;\n}\n\n.recipe-body {\n  padding: 0 10px;\n  margin-bottom: 20px;\n  background-color: #e7e7e7;\n  height: 50%;\n  padding: 15px 15px;\n  border-radius: 0px 0px 5px 5px;\n  overflow: hidden;\n}\n\n.recipe-header {\n  display: flex;\n  justify-content: space-between;\n}\n\n.recipe-title h2 {\n  font-family: 'Lato', sans-serif;\n  font-weight: 400;\n  line-height: 21.6px;\n  font-size: 20px;\n}\n\n.recipe-time {\n  display: flex;\n  position: relative;\n}\n\n.recipe-time p {\n  width: 60px;\n  text-align: end;\n  font-family: 'Lato', sans-serif;\n  font-weight: 700;\n  font-size: 18px;\n  line-height: 21.6px;\n}\n\n.recipe-content {\n  display: flex;\n  justify-content: space-between;\n  padding-top: 10px;\n  padding-bottom: 10px;\n  font-size: 0.7rem;\n  max-height: 140px;\n}\n\n.recipe-ingredients,\n.recipe-describe {\n  width: 50%;\n}\n\n.recipe-ingredients {\n  font-family: 'Lato', sans-serif;\n  font-size: 15px;\n  line-height: 16.4px;\n  font-weight: 700;\n}\n\n\n\n\n.recipe-describe {\n  font-weight: 400;\n  padding-left: 15px;\n  font-family: 'Roboto', sans-serif;\n  font-size: 15px;\n  line-height: 15px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 12;\n  -webkit-box-orient: vertical;\n  \n}\n\nul #search-result {\n  margin: 0;\n}\n\ni {\n  text-transform: lowercase;\n}\n\n#list-ingredients-result {\n   background-color: var(--primary);\n  width: 500px;\n  height: 290px;\n  overflow-x: scroll;\n  &::-webkit-scrollbar{\n    background:var(--primary);\n  }\n  &::-webkit-scrollbar-thumb {\n    background: white;\n    border-radius: 2px;\n    border: 4px solid var(--primary);\n  }\n}\n\n#list-appliance-result {\n   background-color: var(--secondary);\n  width: 500px;\n  height: 290px;\n}\n\n#list-ustensils-result {\n   background-color: var(--tertiary);\n  width: 500px;\n  height: 290px;\n  overflow-x: scroll;\n  &::-webkit-scrollbar{\n    background:var(--tertiary);\n  }\n  &::-webkit-scrollbar-thumb {\n    background: white;\n    border-radius: 2px;\n    border: 4px solid var(--tertiary);\n  }\n}\n\n#ingredients {\n  display: flex;\n  flex-direction: column;\n}\n\n.list-result {\n  display: none;\n  flex-direction: column;\n  flex-wrap: wrap;\n  border-radius: 0px 0px 5px 5px;\n  color: var(--white);\n  margin: -20px 0px 20px 0px;\n}\n#searchBar {\n  margin-bottom: 0px;\n}\n\n#search-result {\n  margin-top: -50px;\n  z-index: -1;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-gap: 40px;\n  border-radius: 20px;\n  margin-top: 50px;\n}\n\n\n.result {\n  top: 60%;\n  right: 40%;\n  display: flex;\njustify-content: center;\ntext-align: center;\n}\n.no-result {\n  background-color: hsl(216, 29%, 84%);\n  margin-top: 20px;\n  padding: 20px;\n  color: #d04f4f;\n  text-align: center;\n  font-family: 'Roboto', sans-serif;\n  font-size: 32px;\n  white-space: nowrap;\n  border-radius: 5px;\n  display: flex;\n  justify-content: center;\n}\n.item-list {\n  padding: 5px 20px 5px 20px;\n   color: white;\n  display: inline-block;\n  margin-bottom: 0;\n  position: relative;\n  &::after {\n  background: none repeat scroll 0 0 transparent;\n  bottom: 0;\n  content: \"\";\n  display: block;\n  height: 5px;\n  position: absolute;\n  background: #fff;\n  transition: width 0.1s ease 0s, left 0.1s ease 0s;\n  width: 0;\n  }\n  &:hover::after {\n    width: 60%;\n    left: 10%;\n  }\n}\n\n\n// .item-ingredients{\n//   background-color: var(--primary-shade);\n// }\n\n// .item-appliance {\n//   // background-color: var(--secondary-shade);\n// }\n\n// .item-ustensils {\n//   // background-color: var(--tertiary-shade);\n// }\n\n.show-list {\n  display: block;\n}\n\n#tags {\n  display: flex;\n  flex-wrap: wrap;\n}\n\n.tag {\n  display: flex;\n  justify-content: space-between;\n  color: var(--white);\n  padding:10px 15px;\n  border-radius: 5px;\n  border-style: none;\n  margin: 5px 10px 5px 5px;\n  align-items: center;\n}\n\n.close-tag {\n  height: 20px;\n  width: 20px;\n  padding-left: 3px;\n  display: block;\n  color: white;\n  cursor: pointer;\n}\n\n.tag-ingredients {\n  background-color: var(--primary);\n}\n\n.tag-appliance {\n  background-color: var(--secondary);\n}\n\n.tag-ustensils {\n  background-color: var(--tertiary);\n}\n\n.fa-xmark {\n  color: white;\n  border: 2px solid white;\n  border-radius: 50%;\n  display: flex;\n  margin-left: 10px;\n}\n\n.fa-xmark::before {\n  /* centrage */\n  line-height: 16px;\n}\n\n/* je relie les deux class */\n.combo-box.open .list-result {\n  display: flex;\n}\n\n.combo-box.open .chevron {\n  transform: rotate(180deg);\n  transition: transform 0.2s;\n}\n\n.combo-box.open input {\n  border-radius: 5px 5px 0px 0px;\n \n}\n\n.combo-box.open .i::placeholder {\n  color: var(--primary-hue) !important;\n}\n\n.combo-box.open .a::placeholder {\n  color: var(--secondary-hue) !important;\n}\n.combo-box.open .u::placeholder {\n  color: var(--tertiary-hue) !important;\n}\n  \n.combo-box.open #search-ingredients {\n  width: 100%;\n}\n.combo-box.open #search-appliance {\n  width: 100%;\n}\n.combo-box.open #search-ustensils {\n  width: 100%;\n}\n\n@media screen and (min-width: 1294px) {\n  #list-ingredients-result,#list-appliance-result,#list-ustensils-result {\n    margin-bottom: -200px\n  }\n  \n}\n\n@media screen and (max-width: 1294px) {\n  #inputs {\n    flex-direction: column;\n    align-items: center;\n  }\n  #ingredients,#appliance,#ustensils {\n    width: 60%;\n  }\n  #list-ingredients-result,#list-appliance-result,#list-ustensils-result {\n    width: 100%;\n  }\n  #search-ingredients, #search-appliance, #search-ustensils {\n    width: 100%;\n  }\n}\n/***************************************************\nTABLETTE\n***************************************************/\n@media screen and (max-width:768px){\n  #ingredients,#appliance,#ustensils {\n    width: 100%;\n  }\n  .container{\n      width: 100%;\n  }\n  #search-result {\n      grid-template-columns: repeat(2,1fr) !important;\n  }\n\n}\n/***************************************************\nMOBILE\n***************************************************/\n@media screen and (max-width: 425px){\n  #search-result {\n      grid-template-columns: auto !important;\n  }\n  #title {\n    font-size: 30px;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/buildDropdown */ "./src/views/buildDropdown.js");
...
searchBarInput.addEventListener("keyup", debounce(function () {
  searchResult.innerHTML = "";
  searchBarFilter();
}, 350));
/**
  ...
  for (var i = 0; i < listResult.length; i++) {
    ...
    for (var j = 0; j < item.length; j++) {
      item[j].addEventListener("click", function (e) {
        ...
        (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildIngredientsList)(tagResult, tagList.filter(function (tag) {
          return tag.type == "ingredients";
        }).map(function (tag) {
          return tag.value;
        }));
        (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildApplianceList)(tagResult, tagList.filter(function (tag) {
          return tag.type == "appliance";
        }).map(function (tag) {
          return tag.value;
        }));
        (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildUstensilsList)(tagResult, tagList.filter(function (tag) {
...
var eraseTags = function eraseTags() {
  ...
  for (var i = 0; i < clsTag.length; i++) {
    clsTag[i].addEventListener("click", debounce(function (e) {
...
var searchBarFilter = function searchBarFilter(input) {
  ...
  (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildApplianceList)(result, tagList.filter(function (tag) {
    return tag.type == "appliance";
  }).map(function (tag) {
    return tag.value;
  }));
  (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildUstensilsList)(result, tagList.filter(function (tag) {
    return tag.type == "ustensils";
  }).map(function (tag) {
    return tag.value;
  }));
...
searchIngredients.addEventListener("keyup", debounce(function () {
  (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildIngredientsList)(_data_recipes_js__WEBPACK_IMPORTED_MODULE_1__.recipes, tagList);
  manageTags();
}, 200));
searchAppliance.addEventListener("keyup", debounce(function () {
  (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildApplianceList)(_data_recipes_js__WEBPACK_IMPORTED_MODULE_1__.recipes, tagList);
  manageTags();
}, 200));
searchUstensils.addEventListener("keyup", debounce(function () {
  (0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildUstensilsList)(_data_recipes_js__WEBPACK_IMPORTED_MODULE_1__.recipes, tagList);
  manageTags();
}, 200));
/**
 * Initialisation
...
(0,_views_buildDropdown__WEBPACK_IMPORTED_MODULE_3__.buildIngredientsList)(_data_recipes_js__WEBPACK_IMPORTED_MODULE_1__.recipes, []);
...
/******/ })()
;
//# sourceMappingURL=90eff4b9d493db3c4bcd.js.map