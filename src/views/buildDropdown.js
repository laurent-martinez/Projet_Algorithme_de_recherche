...
export const buildIngredientsList = (recipes, tagIngredients) => {
...
export const buildApplianceList = (recipes, tagAppliance) => {
...
export const buildUstensilsList = (recipes, tagUstensils) => {
